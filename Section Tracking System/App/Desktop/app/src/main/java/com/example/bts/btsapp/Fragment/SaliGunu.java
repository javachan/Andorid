...
public class SaliGunu extends Fragment {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < datas.length(); i++) {
                        ...
                        if(room.getString("gun").equals("Sali") && room.getString("sinifadi").equals(sinifadi))
