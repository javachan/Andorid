...
public class PazartesiGunu extends Fragment  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        gunlerinBasligi.setText("Pazartesi");
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i = 0; i < datas.length(); i++) {
                        ...
                        if(room.getString("gun").equals("Pazartesi")  && room.getString("sinifadi").equals(sinifadi) )
    ...
    public static PazartesiGunu newInstance(String text) {
        //Burada oluşturduğumuz constructor sayesinde mainfragmentten aldığımız isimler başlığa setlenir.
       PazartesiGunu fragmentismi = new PazartesiGunu();
        Bundle b = new Bundle();
        b.putString("baslık", text);

        fragmentismi.setArguments(b);
